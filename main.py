...
def main():
    ...
    level = 0
    lives = 5
    main_font = pygame.font.SysFont("Monoca", 50)
    lost_font = pygame.font.SysFont("Monoca", 50)
    ...
    def redraw_window():
        ...
        if lost:
            ...
            WIN.blit(lost_label, (WIDTH - lost_label.get_width() / 2, 10))
    ...
    while run:
        ...
        for enemy in enemies[:]:  # copy it
            ...
            if random.randrange(0, 2*60) == 1:  # notice the FPS
                enemy.shoot()
...
def main_menu():
    title_font = pygame.font.SysFont("Monoca", 70)
    run = True
    while run:
        WIN.blit(BG, (0, 0))
        title_label = title_font.render(
            "Press the mouse to begin...", False, (255, 255, 255))
